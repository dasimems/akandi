      ...
      <div className="flex justify-center overflow-hidden">
        <div className="flex flex-col gap-4">
          <section className="relative">
            ...
            <div className="flex flex-col gap-6  text-white text-center">
              <div className="text-center flex  flex-col absolute  top-[40%] left-[33%] items-center">
                ...
                <p className="text-[1.7rem] font-bold ">
                  Car, Truck, Heavy machinery or carvan?{" "}
                </p>
                <div className="mt-8">
                  <Button type="primary" className="font-bold text-lg p-2">
          ...
          <section className="bg-neutraldark-background flex justify-center items-center">
            <div className="py-12">
              <h3 className="text-center text-neutralblack text-lg font-bold">
                Worth Knowing
              </h3>
                ...
                {WorthKnowing.map((item, index) => (
                  <Link key={index} href={item.link}>
                    <div key={index} className="bg-white">
                      ...
                      <div className="p-4">
                        <h4 className="text-md font-medium text-neutraldark">
                          {item.title}
                        </h4>
          ...
          <section className="px-12 py-8 bg-neutraldark-background flex flex-col gap-8">
            <div className="bg-white p-6 px-8 flex flex-col gap-4">
              ...
              <article className="text-md font-normal italic ">
                more than 26000 vehicles and machines are sold annually through
                our marketplace AKandi online. we strive to make the vehicle
                transactions as simple as possible-regardless if you are selling
                or buying through us.
              </article>
              <p className="mt-4 italic text-lg font-normal">
                welcome to Akandi{" "}
              </p>
              <div className="flex justify-between items-center gap-4">
                {option.map((option, index) => (
                  <Link key={index} href={option.link}>
                    <div
                      className="flex justify-center border-2 border-neutraldark-background px-8 py-4 w-[400px] rounded-lg"
                      key={index}
                    >
                      <p> {option.text}</p>
                    </div>
              ...
              <p className="text-center my-6">
                Akandi cars have the highest credit rating{" "}
              </p>
            </div>
            ...
            <div className="flex justify-center ">
              <div className="flex flex-col justify-start gap-4">
                <h4 className="text-2xl font-medium">
                  Be first to get the latest news from <br /> AKandi Online{" "}
                </h4>
                ...
                <div>
                  ...
                  <div className="flex gap-2 items-center">
                    <input
                      ...
                      id="heavyvehicles"
                    />
                    <label htmlFor="heavyvehicles">
                      Heavy Vehicles and Machines{" "}
                    </label>
                  </div>
                </div>
